...
\cventry{2011--\hspace{4.25ex}}{Senior computational biologist}{F. Hoffmann-La Roche AG}{Basel, Switzerland}{}{Bioinformatics research and project support with emphasis in data analysis, data integration, and machine learning/data mining. Building teams with bioinformaticians, statisticians, technical experts and disease experts to support target assessment and identification, stem-cell and animal-model based disease modelling, and mode of action identification. Successfully supported more than 20 drug discovery projects covering from pre-clinical up to Phase IV (post-approval) activities.}
...
\cvitem{Hobbies}{Family, run and bike, programming, reading}
\end{document}
