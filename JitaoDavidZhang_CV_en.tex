...
\cventry{2006--2008}{Scientific programmer}{HUSAR Bioinformatics Group, DKFZ}{Heidelberg}{Germany}{Bioinformatic programming in Perl, C, and C++ for web service and sequence analysis tools.}                % arguments 3 to 6 are optional
...
\cvitem{Hobbies}{Family, running, cycling, reading, programming, photography}
\end{document}
