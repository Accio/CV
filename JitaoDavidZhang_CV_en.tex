...
\cventry{2011--\hspace{4.25ex}}{Computational biologist}{F. Hoffmann-La Roche AG}{Basel, Switzerland}{}{My research focuses on analysis, mining, interpretation, and integration of heterogeneous data to support early drug discovery. My work contributes to target assessment and validation, stem-cell and animal-model based disease modelling, and mode-of-action characterisation and de-risking of drug candidates. With colleagues I co-developed novel platforms and resources such as \textit{Molecular Phenotyping} to support early drug discovery.}
\cventry{2010--2011}{Bioinformatics consultant}{LIFE Biosystems GmbH}{Heidelberg, Germany}{}{Identified plasma microRNAs as signatures for bladder cancer.}
...
\section{Education}
\cventry{2016--2017}{Online training in Medical Chemistry}{}{}{}{}
...
\cventry{2007-2007}{Marie-Curie Fellow}{European Institute of Bioinformatics}{}{Cambridge, UK}{Reearch stay in Dr. Wolfgang Huber's lab to study yeast genetics.}
...
\cvitem{}{$\to$ See full list on Google Scholar at \url{http://goo.gl/ukssrW}}
...
\cvcomputer{Scripting}{Python, Perl, Bash, Erlang}{Web}{HTML/CSS/JavaScript, Django}
...
\vspace*{-1em}
\section{Commitment}
\cvitem{2016--\hspace{4.25ex}}{Supervising bioinformatics and computational biology master students}
\cvitem{2011--\hspace{4.25ex}}{Coaching R programming for basic and advanced levels in Roche}
\cvitem{2012--2013}{Organize and host the seminar series on \emph{Network Analysis} within Roche}
...
\cvcomputer{Marital status}{Married, father of two daughters}{}{}
\cvitem{Hobbies}{I enjoy every second spent with my family. Otherwise I run marathons regularly and ride bicycles almost everyday. When kids sleep I enjoy reading, studying mathematics, and programming for fun.}
\cvitem{misc.}{Holder of \textit{Niederlassungsbewilligung C} of Switzerland}
\end{document}
