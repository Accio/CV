...
\cventry{2011--\hspace{4.25ex}}{Computational biologist}{F. Hoffmann-La Roche AG}{Basel, Switzerland}{}{Project support with experiment design, data analysis and integration, and machine learning/data mining. Building and leading teams of bioinformaticians, statisticians, technical experts and disease experts to support target assessment, stem-cell and animal-model based disease modelling, and omics studies for mode-of-action characterisation of drug candidates. Supported projects target cardiovascular and metabolism diseases, neurological disorders, and infectious diseases.}
...
\cventry{2006--2008}{Scientific programmer}{HUSAR Bioinformatics Group}{Heidelberg}{Germany}{Bioinformatic programming in Perl, C, and C++ for web service and sequence analysis tools.}                % arguments 3 to 6 are optional
...
\section{Selected awards and fellowship}
\cvitem{2008--2011}{Stipend of the \emph{DKFZ International PhD Program}.}
\cvitem{2007--2008}{EU Marie-Curie Fellowship, 6-month stay in Dr. Wolfgang Huber's lab in European Bioinformatics Institute, Hinxton, Cambridge, UK.}
...
\cvitem{2006--2007}{Stipend of the \emph{ZMBH-DKFZ International MCB
    Master Program}.}
...
\cvitem{RTCA}{Open-source analysis software for the Real-Time Cell-Analyzer System\textregistered}
...
\cvcomputer{Scripting}{Python, Bash, Perl, Erlang}{Web}{HTML/CSS/JavaScript, Django}
...
\vspace*{-1em}
\section{Commitment}
\cvitem{2012--2013}{Organize and host the seminar series \emph{Network Analysis} in Roche}
\cvitem{2011--\hspace{4.25ex}}{Coaching R programming for basic and advanced levels in Roche}
\cvitem{2009--2011}{Teaching bioinformatics databases and introductory statistics in the master-level course \emph{Molecular and cellular biology}}
\cvitem{2009--2011}{Coaching R programming for basic and advanced levels in DKFZ}
...
\cvitem{Hobbies}{Family, run and bike, mathematics, programming, reading}
\cvitem{misc.}{Holder of \textit{Niederlassungsbewilligung C}}
\end{document}
