...
\cvlistitem{15+ years of experience in computational biology and drug discovery.}
...
\cvlistitem{Founded and led interdisciplinary teams with scientific and strategic impact.}
...
\cvlistitem{Contributor to education and scientific communities.}
\cvlistitem{Collaborates across Roche, academia, and industry to advance research.}

\section{Professional experience}

\cventry{2026--\hspace{4.25ex}}{Dr. Habil. and Venia Docenti}{University of Basel}{Basel}{Switzerland}{Habilitation and permission to teach computational biology and drug discovery.}
\cventry{2022--\hspace{4.25ex}}{Expert scientist}{F. Hoffmann-La Roche AG}{Basel}{Switzerland}{Supporting portfolio projects by developing and applying emerging technologies, validating and developing human-relevant model systems, and designing and implementing computational tools to empower translational research. Highlights include critical support for entry into first-in-human and clinical trials of several drug candidates including Zosurabalpin (currently tested in Phase III clinical trials) and Selnoflast (Phase Ib Experimental Medicine study), research on protein turnover and applications for target and modality selection, a systematic analysis of reasons for attrition of drug discovery and development projects, as well as development of computational and experimental workflows to characterize efficacy and safety profiles of drug candidates using (phospho)proteomics and chemical probes.}
\cventry{2021--\hspace{4.25ex}}{Apprenticeship trainer and examination expert}{}{}{Switzerland}{Training vocational apprentices specializing in computational sciences, application development, and platform development, and hosting qualification examinations.}
\cventry{2018--\hspace{4.25ex}}{Lecturer}{University of Basel}{Basel}{Switzerland}{Teaching two graduate- and post-graduate-level courses at the Department of Mathematics and Computer Science, \href{http://amidd.ch}{\emph{Applied Mathematics and Informatics in Drug Discovery}} (AMIDD) and \href{http://mcbdd.ch}{\emph{Computational and Mathematical Biology in Drug Discovery}} (MCBDD), as well as contributing to other lecture series.}
...
\cventry{2005--2006}{Journalist and associate editor}{Kicker China}{Beijing}{China}{Translating German articles on European football leagues and reporting on the German football league (German: \textit{Bundesliga}) for Chinese readers}
...
\cvitem{2024--2025}{I assumed the role of Portfolio Lead for cardiovascular metabolism, immunology, infectious disease, and ophthalmology within the Predictive Modeling and Data Analytics team. I coordinated project support and innovation activities with input from more than 60 experts with a wide range of expertise in computational biology, biostatistics, translational modeling and simulation, disease modeling, and pharmacometrics. I worked closely with other Portfolio Leads to present the team in communities and decision boards. Our teamwork made a critical impact on dozens of portfolio projects ranging from entry into portfolio to clinical trials and filing.}
...
\cvitem{2022--2024}{I co-founded and led a new research group within my organization, with 6 permanent positions, 2 postdocs, and interns. The team consisted of computational scientists with training or working experience in toxicology, chemistry, biology, and statistics. I led the interviews and the onboarding of new employees. I was responsible for integrating the team in the working environment, embedding the team in the process of drug discovery and development, and defining the team's vision, strategy, and scientific focus. The team grew to become an indispensable unit in our organization.}
\cvitem{2022--2023}{I led a cross-functional team of about 30 people to improve the productivity and efficiency with regard to data, insight, and knowledge management. Stakeholders and team members gave positive feedback on the team's organization and output. The outcome has led to changes in how data and computational models are captured and used.}
...
\cvitem{Dr. Milad Adibi}{2020-2022 (co-supervision with Dr. Ekaterina Breous-Nystrom), multiscale modeling of drug-induced liver toxicity}
\cvitem{Dr. Simon Gutbier}{2018-2020 (co-supervision with Dr. Christoph Patsch and Dr. Markus Britschgi), immune pathway characterization with tool-compound screening for Parkinson's Disease}
...
\cvitem{Simon Crouzet}{2022, internship working on predicting protein-ligand interaction with graph neural networks}
\cvitem{Anja Lieberherr}{2022-2023 (co-supervision with Prof. Niko Beerenwinkel at ETH), master thesis on applying graph neural networks in drug discovery}
\cvitem{Sarah Morillo}{2021-2022, internship working on proteomics data and protein half-life}
\cvitem{Andreea Ciuprina}{2020 (co-supervision with Prof. Niko Beerenwinkel), internship and master thesis on computational inference of immune-cell contribution to drug-induced liver toxicity}
\cvitem{Rudolf Biczok}{2018-2019 (co-supervision with Prof. Alexandros Stamatakis, KIT), internship and master thesis on building a gene-expression database and evaluating gene-set comparison metrics}
\cvitem{Moaraj Hasan}{2017-2018, internship working on automating gene-expression data analysis}
\cvitem{Tao Fang}{2017-2018 (co-supervision with Prof. Mark Robinson, UZH), internship and master thesis on histopathology prediction with deep neural networks}
\cvitem{Gregor Sturm}{2016-2017, internship working on gene signatures and the BioQC software}

\subsection{Vocational apprentices specializing in computer sciences}

\cvitem{Rigani Jegatheeswaran}{2025-2026, currently working with Roche}
\cvitem{David Weber}{2025-2026, currently working with Roche}
\cvitem{Nina Lareida}{2024-2025, currently working part-time at Roche}
\cvitem{Niklas Trapp}{2024-2025, currently working with Roche}
\cvitem{Giulia Ferraina}{2023-2024, currently working part-time at Roche and studying computer science at FHNW}
\cvitem{Jannick Lippuner}{2023-2024, currently working with Roche}
\cvitem{Yannik Benndorf}{2022-2023, currently studying computer sciences at TU München}
...
\cvitem{Leonardo Seminatore}{2021-2022, currently pursuing a bachelor of science in geomatics, FHNW}

\section{Outreach}

\subsection{Teaching activities}

\cvitem{2026--\hspace{4.25ex}}{European Center of Pharmaceutical Medicines (ECPM), Faculty of Medicine, University of Basel, teaching in the module~\textit{From Non-Clinical Testing to First-in-Human}}
\cvitem{2020--2023}{Courses on causal inference and computational toxicology for the PSI (Statisticians in the Pharmaceutical Industry) community, once a year}
...
\subsection{Selected public talks}

\cvitem{2026}{\textit{Interdisziplinarität in der Industrieforschung und im Alltag}, in-service teacher training (\textit{Schulinterne Weiterbildung}), Gymnasium Muttenz, Basel-Landschaft, Switzerland}
\cvitem{2025}{\textit{Defining Human Dosing for Covalent Inhibitors with Translational PK/PD and Protein Turnover Data}, co-presenting with Neil John Parrott, DMDG Meeting \textit{Focusing on Targeted Covalent Drugs: how to best identify and develop Target Covalent Inhibitors}, Basel, Switzerland}
\cvitem{2025}{\textit{Oneness of Target and Modality Selection in Drug Discovery}, Institute of Molecular Systems Biology, ETH Zürich}
...
\cvitem{2026--\hspace{4.25ex}}{Examination validation expert for vocational apprenticeship in computer sciences}
\cvitem{2025--\hspace{4.25ex}}{Elected member of School Council (\textit{Schulrat}) of the Wasserstelzen primary school, Riehen, Basel, Switzerland}
\cvitem{2024--\hspace{4.25ex}}{Examination expert for vocational apprenticeship in computer sciences}
\cvitem{2023--\hspace{4.25ex}}{Member of interview and selection committees for tenure-track positions in universities}
...
\cvitem{2021--\hspace{4.25ex}}{Member of Parents' Council (\textit{Elternrat}) of the Erlensträsschen primary school, Riehen, Basel, Switzerland}
\cvitem{2021--\hspace{4.25ex}}{Certified vocational trainer (\textit{Lehrmeister}) for vocational apprenticeship in computer sciences}
...
\cvitem{2014--\hspace{4.25ex}}{Reviewing research proposals and funding grants for multiple national funding agencies}
