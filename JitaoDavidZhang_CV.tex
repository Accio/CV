...
\cvlistitem{Computational biologist with 15+ years' industrial research experience}
\cvlistitem{Critical contributions to drug candidates and marketed products}
...
\cvlistitem{Teaching courses and supervising postdocs, students, and apprentices}
\cvlistitem{Experience in establishing research group and leading teams}
...
\cventry{2022--\hspace{4.25ex}}{Expert scientist}{F. Hoffmann-La Roche AG}{Basel}{Switzerland}{Devising and implementing the concept of Iterative Quantitative Benefit-Risk Evaluation (IQ-BRE) for drug-discovery projects. Highlights include critical support for a Phase 1 clinical trial of the drug candidate Selnoflast, causal inference in drug discovery and development, leveraging protein turnover for drug discovery, and integrated target and modality selection.}
...
\cvitem{2023}{Courzet \textit{et al.} G-PLIP: Knowledge graph neural network for structure-free protein-ligand affinity prediction}
\cvitem{2023}{Valeanu \textit{et al.} Kinex infers causal kinases from phosphoproteomics data}
\cvitem{2023}{Rot \textit{et al.} splicekit: a comprehensive toolkit for splicing analysis from short-read RNA-seq}
