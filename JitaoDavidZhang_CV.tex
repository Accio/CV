...
\cvlistitem{Open-source software developer and open-access author (50+
publications, \textit{h}-index 24).}
...
\cvitem{2018--\hspace{4.25ex}}{Lecture series~\textit{Introduction to
...
of Basel.} \cvitem{2018--\hspace{4.25ex}}{Participation in the lecture
series~\textit{From Novel Targets To Novel Therapeutic Modalities}, MSc Drug
Sciences, University of Basel.} \cvitem{2016--\hspace{4.25ex}}{Supervising
...
\cvitem{2012--\hspace{4.25ex}}{Acting as reviewers for \emph{Bioinformatics},
\emph{BMC Syst. Biol.}, \emph{Stat. Biopharm. Res.}, \emph{NAR Genomics and
Bioinformatics}, \emph{PLOS Comp Bio}, \textit{etc.}}
\cvitem{2012--\hspace{4.25ex}}{Leading seminar/course series about
\emph{Network Analysis}, \emph{R programming}, \emph{Bioinformatics In Drug
Discovery}, \textit{etc.} Certificated as a Carpentury Instructor in 2020.}
